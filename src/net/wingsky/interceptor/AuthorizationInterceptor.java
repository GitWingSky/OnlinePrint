package net.wingsky.interceptor;
...
public class AuthorizationInterceptor  implements HandlerInterceptor {
	...
	private static final String[] IGNORE_URI = {"/loginForm", "/login" , "/index" , "/sendEmail" , "/checkUser" , "/register" , "/readme"};
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        if (!flag){
        	...
        	if(user == null){
        		...
        		if(servletPath.contains("/shopAdmin")){
        			User uuser = userService.getById(user.getUserId());
        			if(!uuser.getUserType().equals("2")){
                		response.sendRedirect("home");
                	}
        		}
